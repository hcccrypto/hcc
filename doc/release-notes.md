...
installer (on Windows) or just copy over /Applications/HCC-Qt (on Mac) or
...
first startup of HCC Core will run a migration process which can take a few
